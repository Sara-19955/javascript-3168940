export let comic = {
  banners: [
    "./IMGS/banner_prueba_1.png",
    "./IMGS/banner_prueba_2.png",
    "./IMGS/banner_prueba_3.png",
    "./IMGS/banner_prueba_4.png",
  ],
